...
class OBDPort:
     ...
     def __init__(self,logger,portnum,_notify_window,SERTIMEOUT,RECONNATTEMPTS):
         ...
         self.logger.displayText("Opening interface...")
         ...
         self.logger.displayText("OBD Interface " + self.port.portstr + " opened")
         self.logger.displayText("Connecting to ECU...")
         ...
         self.logger.displayText("atz response:" + self.ELMver)
         self.send_command("ate0")  # echo off
         self.logger.displayText("ate0 response:" + self.get_result())
         self.send_command("0100")
         ready = self.get_result()
         self.logger.displayText("0100 response:" + ready)
     ...
     def get_result(self):
         ...
         if self.port is not None:
            ...
            self.logger.displayText("NO self.port!")
         return None
